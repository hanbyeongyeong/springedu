 ...
 */				
				...
				$.each(data.item,function(idx, rec){
						console.log(rec.rrdto);
						
						if(rec.rrdto != null){
							rrnickname = '@'+rec.rrdto.rnickname; //부모댓글의 별칭
							rrid	   = rec.rrdto.rrid;	//부모댓글의 아이디
						}
					...
					if(rec.isdel =='Y'){
						...
						// 1step
							...
							str += "        <p clsss='replybody'><span class='mr-1 text-warning'>삭제된게시물입니다</span></p>"
							str += "      </div>";
							str += "    </div>";					
						}else{
					...
					// 1step
						...
						str += "    <div class='row m-0 p-0'>";
						str += "      <div class='col-1'>";
						str += "      <img src='/resources/images/man.jpeg' class='m-1 rounded-circle' style='width:45px;'>";
						str += "      </div>";
						str += "      <div class='col-11'>";
						str += "        <h6>"+rec.rnickname+"("+rec.rid+") <small class='ml-2'><i>"+rec.rcdate+"</i></small></h6>";
						/* str += "          <span>"+rec.rrdto+"</span>" ; */
...
<div class="container">
<!-- 댓글 등록 -->
<table class="table table-sm table-borderless table-gray">
  <colgroup>
    <col width="10%">
    <col width="80%">
    <col width="10%">
