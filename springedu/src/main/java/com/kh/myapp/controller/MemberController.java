...
//	@RequestMapping(value="/upload",method=RequestMethod.POST) /*밑과 같은 의미*/
	...
	public ResponseEntity<String> doUpload(@RequestParam("file") MultipartFile file, Model model) {

		ResponseEntity<String> resCode = null;
		String randomFileName = null; //난수파일명
		String originFileName = null; //초기파일명
		String fileLocation ="D:\\HB\\git\\repository\\springedu\\src\\main\\resources\\upload";
