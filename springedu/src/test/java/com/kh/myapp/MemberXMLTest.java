...
class MemberXMLTest {
	...
	void test() {
		...
		memberDTO.setId("qq@qq.com");
		memberDTO.setPw("1234");
		memberDTO.setTel("010-3210-5678");
		memberDTO.setNickName("테스터30");
		memberDTO.setGender("남");
		memberDTO.setRegion("울산");
		memberDTO.setBirth("2020-01-09");
	...
	//@Test
	void findId(){
		MemberDTO mdto = xml.findId("010-3210-5678","2020-01-09");
		 logger.info("회원조회:"+mdto);
	}
	
	@Test
	void findPw(){
		MemberDTO mdto = xml.findPw("qq@qq.com","010-3210-5678","2020-01-09");
		 logger.info("회원조회:"+mdto);
	}
